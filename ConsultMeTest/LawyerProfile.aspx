                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mx-auto">
                            ...
                            <div class="col-md-4">
                                <label style="font-weight: bold">Case Won</label>
                                <asp:TextBox CssClass="form-control" ID="Case_won" runat="server" placeholder="Case Won" BackColor="White" BorderColor="Black" BorderStyle="Solid" TextMode="Number"></asp:TextBox>
                            </div>
                            <div class="col-md-4">
