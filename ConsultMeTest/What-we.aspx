<%@ Page Title="" Language="C#" MasterPageFile="~/Consult.Master" AutoEventWireup="true" CodeBehind="What-we.aspx.cs" Inherits="ConsultMeTest.What_we" %>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="service_box">
                                 ...
                                 <div class="readmore_button"><a href="readmore1.html">Read More</a></div>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="service_box active">
                                 ...
                                 <p class="chunks_text">chunks as necessary, making this the first true generator on the Internet. It uses a dictionary </p>
                                 <div class="readmore_button active"><a href="readmore2.html">Read More</a></div>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="service_box">
                                 ...
                                 <h3 class="corporate_text">Find lawyers acc requirement</h3>
                                 <p class="chunks_text">chunks as necessary, making this the first true generator on the Internet. It uses a dictionary </p>
                                 <div class="readmore_button"><a href="readmore3.html">Read More</a></div>
                              </div>
                           </div>
                        </div>
                     </div>
